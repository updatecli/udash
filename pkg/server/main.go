...
func (s *Server) Run() {
	...
	case "oauth":
		...
		r.GET("/api/pipeline/config/sources/kind", checkJWT(), SearchConfigSourcesKind)
		...
		r.GET("/api/pipeline/config/conditions/kind", checkJWT(), SearchConfigConditionsKind)
		...
		r.GET("/api/pipeline/config/targets/kind", checkJWT(), SearchConfigTargetsKind)
		if !s.Options.DryRun {
	...
	case "", "none":
		...
		r.GET("/api/pipeline/config/sources/kind", SearchConfigSourcesKind)
		...
		r.GET("/api/pipeline/config/conditions/kind", SearchConfigSourcesKind)
		r.GET("/api/pipeline/config/targets", ListConfigTargets)
		r.POST("/api/pipeline/config/targets/search", SearchConfigTargets)
		r.GET("/api/pipeline/config/targets/kind", SearchConfigSourcesKind)
		if !s.Options.DryRun {
